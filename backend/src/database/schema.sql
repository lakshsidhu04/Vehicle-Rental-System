...
CREATE TABLE IF NOT EXISTS earnings (
    ...
    net_profit DECIMAL(10, 2) GENERATED ALWAYS AS (total_revenue - total_expenses) VIRTUAL,  -- Changed to VIRTUAL
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    customer_id INT NOT NULL,
    booking_id INT NULL,  -- Made nullable for non-booking transactions
